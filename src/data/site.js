...
export const footer = {
  ...
  payments: {
    ...
    items: [
      { name: "Visa", image: "/images/footer/pay-visa.webp" },
      { name: "Mastercard", image: "/images/footer/pay-mastercard.svg" },
      { name: "RuPay", image: "/images/footer/pay-rupay.webp" },
      { name: "UPI", image: "/images/footer/pay-upi.webp" },
      { name: "Google Pay", image: "/images/footer/pay-gpay.webp" },
      { name: "PhonePe", image: "/images/footer/pay-phonepe.webp" },
      { name: "Paytm", image: "/images/footer/pay-paytm.webp" },
      { name: "BHIM", image: "/images/footer/pay-bhim.webp" },
      { name: "Net Banking", image: "/images/footer/pay-netbanking.webp", label: "Net Banking" },
      { name: "Razorpay", image: "/images/footer/pay-razorpay.webp" },
    ],
  },
  badges: [

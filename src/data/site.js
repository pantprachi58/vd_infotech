...
export const footer = {
  ...
  expansionCities: [
    { name: "Greater Noida", icon: "/images/Indian states/Greater noida.png" },
    { name: "Mumbai", icon: "/images/Indian states/Mumbai.png" },
    { name: "Chandigarh", icon: "/images/Indian states/Chandigarh.png" },
    { name: "Bengaluru", icon: "/images/Indian states/Bengaluru.png" },
    { name: "Ahmedabad", icon: "/images/Indian states/Ahmedabad.png" },
    { name: "Gurugram", icon: "/images/Indian states/Gurugram (1).png" },
    { name: "Jaipur", icon: "/images/Indian states/Jaipur.png" },
    { name: "Pune", icon: "/images/Indian states/Pune.png" },
    { name: "Guwahati", icon: "/images/Indian states/Guwahati.png" },
    { name: "Indore", icon: "/images/Indian states/Indore.png" },
  ],
  targetMarkets: [
    { name: "UK", icon: "/images/international/uk.png" },
    { name: "Malaysia", icon: "/images/international/Malaysia.png" },
    { name: "UAE", icon: "/images/international/UAE.png" },
    { name: "Canada", icon: "/images/international/Canada.png" },
    { name: "Australia", icon: "/images/international/Australia.png" },
    { name: "USA", icon: "/images/international/USA.png" },
    { name: "Indonesia", icon: "/images/international/indonesia.png" },
    { name: "China", icon: "/images/international/China.png" },
    { name: "Japan", icon: "/images/international/Japan (1).png" },
    { name: "Germany", icon: "/images/international/Germany.png" },
  ],
  certifications: [
    // Row 1
    "/images/all certifications logo  icons/IAB 2.png",
    "/images/all certifications logo  icons/ROC 2.png",
    "/images/all certifications logo  icons/PCI-logo 2.png",
    "/images/all certifications logo  icons/Shopify-Certified-Partner-Logo 3.png",
    "/images/all certifications logo  icons/google-ads-certification 1.png",
    // Row 2
    "/images/all certifications logo  icons/nasscom-member 2.png",
    "/images/all certifications logo  icons/ISO-27001-logo-eturia 2.png",
    "/images/all certifications logo  icons/AWS 2.png",
    "/images/all certifications logo  icons/Bing_logo_(2016).svg 3.png",
    "/images/all certifications logo  icons/hubspot 1.png",
    // Row 3
    "/images/all certifications logo  icons/dpiit-0-1681728843_1729501601_880X580_c_c_0_0_1-removebg-preview 1.png",
    "/images/all certifications logo  icons/PAN 2.png",
    "/images/all certifications logo  icons/1723808722meta-logo-png-1.webp",
    "/images/all certifications logo  icons/Group 48095604.png",
    "/images/all certifications logo  icons/stc_logo_1-removebg-preview 1.png",
    // Row 4
    "/images/all certifications logo  icons/google_certifications_1-removebg-preview 1.png",
    "/images/all certifications logo  icons/MSME_1-removebg-preview 1.png",
    "/images/all certifications logo  icons/_734FDB24-0454-45FF-8C06-796BA1C57DE3_-removebg-preview 1.png",
    "/images/all certifications logo  icons/SEMRush-Academy 2.png",
    "/images/all certifications logo  icons/CIM_Lockup_BLUE_RGB_1-removebg-preview 1.png",
  ],
  payments: [
    "/images/Paymets apps/visa-card-logo-9 2.png",
    "/images/Paymets apps/logos_mastercard.png",
    "/images/Paymets apps/Rupay-Logo 2.png",
    "/images/Paymets apps/UPI_logo_PNG_lyp5s5 2.png",
    "/images/Paymets apps/google-pay-38 2.png",
    "/images/Paymets apps/phonepay.png",
    "/images/Paymets apps/PAYTM.NS_BIG 2 (2).png",
    "/images/Paymets apps/bhim.png",
    "/images/Paymets apps/Razor pay.png",
    "/images/Paymets apps/net banking.png",
  ],
  badges: [
